...
public class createSignUp {
    ...
    public createSignUp(WebDriver driver, WebDriverWait wait)
    {
        this.driver=driver;
        this.wait=wait;
    }
    ...
    public void promoDetail() throws InterruptedException {
        driver.findElement(byTitle).sendKeys("PromoVDS "+getRandomNumber());
       // Thread.sleep(1000);
    ...
    {
        driver.findElement(byPromoCode).sendKeys("PromoVDS"+getRandomNumber());
