...
public class createFreeDelivery {
   ...
   // public static By byFreeDelivery = By.cssSelector("#root > div > div.main-section > div.route-root > div > div.create-promo-root > div > div.promo-body > div.promo-type-section > div.MuiTabs-root.tabs-container > div > div > button.MuiButtonBase-root.MuiTab-root.MuiTab-textColorInherit.tab-root.Mui-selected > span.MuiTab-wrapper");
    public static By byFreeDelivery = By.cssSelector("#root > div > div.main-section > div.route-root > div > div.create-promo-root > div > div.promo-body > div.promo-type-section > div.MuiTabs-root.tabs-container > div > div > button:nth-child(3) > span.MuiTab-wrapper");
    public static By byUsageLimit = By.cssSelector("#root > div > div.main-section > div.route-root > div > div.create-promo-root > div > div.promo-body > div.form-section > div:nth-child(5) > div.section-fields > div:nth-child(1) > div > input");
    public static By byUsageLimitPerUser = By.cssSelector("#root > div > div.main-section > div.route-root > div > div.create-promo-root > div > div.promo-body > div.form-section > div:nth-child(5) > div.section-fields > div:nth-child(2) > div > input");
    public static By byminAmount = By.cssSelector("#root > div > div.main-section > div.route-root > div > div.create-promo-root > div > div.promo-body > div.form-section > div:nth-child(5) > div.section-fields > div:nth-child(3) > div > input");
    public static By bymaxDiscount =  By.cssSelector("#root > div > div.main-section > div.route-root > div > div.create-promo-root > div > div.promo-body > div.form-section > div:nth-child(5) > div.section-fields > div:nth-child(4) > div > input");
    ...
    public createFreeDelivery(WebDriver driver,WebDriverWait wait) throws InterruptedException {
        this.driver = driver;
        this.wait=wait;
    }
    ...
    public void clickFreeDelivery() throws InterruptedException {
            driver.findElement(byFreeDelivery).click();
          //  Thread.sleep(5000);
        }
    ...
    public void promoDetail() throws InterruptedException {
        driver.findElement(byTitle).sendKeys("PromoVDFD "+getRandomNumber());
      //  Thread.sleep(1000);
