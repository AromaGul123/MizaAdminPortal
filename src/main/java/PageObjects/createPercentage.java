...
public class createPercentage {
    ...
    public createPercentage(WebDriver driver, WebDriverWait wait)
    {
        this.driver=driver;
        this.wait=wait;
    }
    ...
    public void promoDetail() throws InterruptedException {
        driver.findElement(byTitle).sendKeys("PromoVDP "+getRandomNumber());
      //  Thread.sleep(1000);
    ...
    public void discountDetails() throws InterruptedException {
      ...
      //  Thread.sleep(1000);
        driver.findElement(byPromoCode).sendKeys("PromoVDP"+getRandomNumber());
    }
